/**
 * Orthopedics Specialty Types
 * 
 * TypeScript interfaces and types specific to orthopedics practice,
 * extending the base EHR types with orthopedics-specific data structures.
 */

import { IntakeFormData } from '../../../ehr-integrations/types';

/**
 * Orthopedics-specific intake form data
 */
export interface OrthopedicsIntakeData extends IntakeFormData {
  /** Orthopedics-specific data */
  specialtyData: OrthopedicsSpecialtyData;
}

/**
 * Orthopedics specialty-specific data structure
 */
export interface OrthopedicsSpecialtyData {
  /** Assessment findings */
...
/**
 * Assessment findings for orthopedics
 */
