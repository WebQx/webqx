...
"Work" shall mean the work of authorship, whether in Source or Object form, made available under the License, as indicated by a copyright notice that is included in or attached to the work (which shall not include communication that is conspicuously marked or otherwise designated in writing by the copyright owner as "Not a Contribution").
...
"Contributor" shall mean Licensor and any individual or Legal Entity on behalf of which a Contribution has been received by Licensor and subsequently incorporated within the Work.
...
## Contributor IP Addendum Notice

**IMPORTANT:** All contributors to this project must also execute the Intellectual Property Addendum found at [`./legal/ip-addendum.md`](./legal/ip-addendum.md) to ensure legal clarity and proper assignment of intellectual property rights. This addendum complements the Apache 2.0 license and provides additional protection for both contributors and the project.

For collaboration involving sensitive information, contributors may also be required to execute the Non-Disclosure Agreement template found at [`./legal/nda-template.md`](./legal/nda-template.md).

These additional legal documents are designed to support scalable open-source healthcare development while maintaining appropriate legal protections for all parties involved.