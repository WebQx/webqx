...
// Security middleware - modified for Lambda
app.use(helmet({
...
// Rate limiting for FHIR endpoints - reduced for Lambda
const fhirLimiter = rateLimit({
    windowMs: 15 * 60 * 1000, // 15 minutes
    max: 1000, // Higher limit for Lambda since each instance handles fewer concurrent users
    message: {
...
// Serve static files - for Lambda, these should be served from S3 or included in package
...
// Export the app instead of listening on a port (Lambda doesn't need to listen)
module.exports = app;